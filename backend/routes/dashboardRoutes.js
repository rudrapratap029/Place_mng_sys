...
const {getDashboardSummary, getRecentCompanies ,getUpcomingDeadlines ,  getRecentApplications, getApplicationStatusAnalytics,  getStudentsByBranch , getCompanyStatusAnalytics} = require("../controllers/dashboardController");
